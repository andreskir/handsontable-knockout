...
function ViewModel(albums){
  ...
  this.fields = ko.observableArray([
    ...
    { name: 'country', type: 'autocomplete', text: "Country", selectorData: [{id:'AR',text:'Argentina'},{id:'BR',text:'Brasil'},{id:'CH',text:'Chile'},{id:'UY',text:'Uruguay'}] },
    { name: 'authors', type: 'autocomplete', text: "Authors", selectorData: [{id:'CP',text:'Charles Perez'},{id:'NG',text:'Nick Gomez'},{id:'WW',text:'Walter White'},{id:'ER',text:'Edward Rodriguez'}] }
  ]);
