$(document).ready(function () {
  ...
  var fields = [{ name: 'title', text: "Plain text title", value: 'A', _type: "Field" },
    ...
    { name: 'country', text: "Country", value: null, _type: "Selector", selectorData: [{id:'AR',text:'Argentina'},{id:'BR',text:'Brasil'},{id:'CH',text:'Chile'},{id:'UY',text:'Uruguay'}] },
    { name: 'authors', text: "Authors", value: null, _type: "MultiValue", selectorData: [{id:'CP',text:'Charles Perez'},{id:'NG',text:'Nick Gomez'},{id:'WW',text:'Walter White'},{id:'ER',text:'Edward Rodriguez'}] },
