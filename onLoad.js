$(document).ready(function () {
  ...
  var fields = [{ name: 'title', type: 'text', text: "Plain text title", value: null, _type: "Field" },
    ...
    { name: 'authors', type: 'autocomplete', text: "Authors", value: null, _type: "Selector", selectorData: [{id:'CP',text:'Charles Perez'},{id:'NG',text:'Nick Gomez'},{id:'WW',text:'Walter White'},{id:'ER',text:'Edward Rodriguez'}] }
  ];
